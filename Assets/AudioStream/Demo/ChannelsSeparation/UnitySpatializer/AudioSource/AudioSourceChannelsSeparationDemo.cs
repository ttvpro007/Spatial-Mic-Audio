...
public class AudioSourceChannelsSeparationDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("This scene plays a multichannel AudioSource/AudioClip and instantiates single channel AudioSource per current Unity output channel in the scene with audio from it\r\n" +
            "- original AudioClip is up/down mixed by Unity as needed for current output before splitting");
