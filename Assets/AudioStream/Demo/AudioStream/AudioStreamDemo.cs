...
public class AudioStreamDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        for (var aidx = 0; aidx < this.audioStreams.Length; ++aidx)
        {
            ...
            //GUILayout.Space(10);
            //audioStream.continuosStreaming = GUILayout.Toggle(audioStream.continuosStreaming, "Auto reconnect/play again when the connection is dropped/finished.", AudioStreamSupport.UX.guiStyleLabelNormal);
