    ...
    void OnGUI()
    {
        ...
        using (new GUILayout.HorizontalScope())
        {
            using (new GUILayout.VerticalScope(GUILayout.MaxWidth(Screen.width / 2)))
            {
                ...
                GUILayout.Label(string.Format("Time: {0}", Log.TimeStringFromSeconds(this.audioStream.PositionInSeconds)), AudioStreamDemoSupport.guiStyleLabelNormal);
                ...
                GUILayout.Label(Mathf.Round(asource.volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);

                GUILayout.EndHorizontal();

                /*
                GUILayout.BeginHorizontal();
                GUILayout.Label("Stream buffer size: ", AudioStreamDemoSupport.guiStyleLabelNormal);
                ...
                GUILayout.Label(" bytes", AudioStreamDemoSupport.guiStyleLabelNormal);
                GUILayout.EndHorizontal();
                */
            ...
            using (new GUILayout.VerticalScope(GUILayout.MaxWidth(Screen.width / 2)))
            {
                GUILayout.Label(this.audioStreamInput2D.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);
                ...
                GUILayout.Label(Mathf.Round(this.audioStreamInput2D.gain * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);
                ...
                if (GUILayout.Button(this.audioStreamInput2D.isRecording ? "Stop" : "Record", AudioStreamDemoSupport.guiStyleButtonNormal))
                ...
                if (this.audioStreamInput2D.isRecording)
                {
                    if (GUILayout.Button(this.audioStreamInput2D.isPaused ? "Resume" : "Pause", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        GUILayout.Label(this.icecastSource.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);

        GUILayout.Label("Press Connect to connect and start pushing to an Icecast mount point after entering all parameters.", AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.BeginHorizontal();
        GUILayout.Label("Host: ", AudioStreamDemoSupport.guiStyleLabelNormal);
        this.icecastSource.hostname = GUILayout.TextField(this.icecastSource.hostname, GUILayout.MaxWidth(Screen.width / 2));
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.Label("Port: ", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("Mountpoint: ", AudioStreamDemoSupport.guiStyleLabelNormal);
        this.icecastSource.mountPoint = GUILayout.TextField(this.icecastSource.mountPoint, GUILayout.MaxWidth(Screen.width / 2));
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.Label("Password: ", AudioStreamDemoSupport.guiStyleLabelNormal);
        this.icecastSource.password = GUILayout.TextField(this.icecastSource.password, GUILayout.MaxWidth(Screen.width / 2));
        GUILayout.EndHorizontal();

        using (new GUILayout.HorizontalScope())
        {
            GUILayout.Label("Codec: ", AudioStreamDemoSupport.guiStyleLabelNormal, GUILayout.MaxWidth(Screen.width / 4));
            this.icecastSource.codec = (IcecastSource.IcecastSourceCodec)GUILayout.SelectionGrid((int)this.icecastSource.codec, System.Enum.GetNames(typeof(IcecastSource.IcecastSourceCodec)), 3, AudioStreamDemoSupport.guiStyleButtonNormal, GUILayout.MaxWidth(Screen.width / 4 * 3));
        }


        var connected = this.icecastSource.Connected;

        GUILayout.Label("Host: " + this.icecastSource.hostname, AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label("Port: " + this.icecastSource.port, AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        if (GUILayout.Button(connected ? "Disconnect" : "Connect", AudioStreamDemoSupport.guiStyleButtonNormal))
        {
            if (connected)
