...
public class ResonanceSoundfieldDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        AudioStreamDemoSupport.GUIHeader(this.resonanceSoundfield ? " " + this.resonanceSoundfield.fmodVersion : "");
        ...
        GUILayout.Label(this.resonanceSoundfield.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);
        ...
        using (new GUILayout.HorizontalScope())
        {
            GUILayout.Label(string.Format("Volume: {0} dB", Mathf.RoundToInt(this.resonanceSoundfield.gain)), AudioStreamDemoSupport.guiStyleLabelNormal, GUILayout.MaxWidth(Screen.width / 2));
        ...
        */
        ...
        if (GUILayout.Button(this.resonanceSoundfield.isPlaying ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        if (this.resonanceSoundfield.isPlaying)
        {
            if (GUILayout.Button(this.resonanceSoundfield.isPaused ? "Resume" : "Pause", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        GUILayout.Label("B-format ambisonic 'Leonard-Orfeo_Trio'.\r\nRecording from https://github.com/ambisonictoolkit/atk-sounds, used according to license therein.", AudioStreamDemoSupport.guiStyleLabelNormal);
