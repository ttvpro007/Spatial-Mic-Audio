...
public class AudioSourceOutputDeviceDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("This scene will play AudioStream playback components and regular Unity AudioSource on selected system output. Mixing is done by FMOD automatically.", AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label("Select output device and press Play (default output device is preselected). You can switch between outputs while playing.", AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label("NOTE: you can un/plug device/s in your system during runtime - the device list should update accordingly", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label("Available output devices:", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        this.selectedOutput = GUILayout.SelectionGrid(this.selectedOutput, this.availableOutputs.Select((output, index) => string.Format("[Output #{0}]: {1}", index, output.name)).ToArray()
            , 1, AudioStreamDemoSupport.guiStyleButtonNormal);

        GUILayout.Label(string.Format("-- user requested {0}, running on {1}", this.audioSourceOutput.outputDevice.name, this.audioSourceOutput.RuntimeOutputDriverID), AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label(this.audioStream.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);

        GUILayout.BeginHorizontal();
        GUILayout.Label("Stream: ", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label(string.Format("Input mix latency: {0} ms", asod.inputLatency), AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label(string.Format("Output device latency average: {0} ms{1}", asod.latencyAverage, underflow), AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label(Mathf.Round(_as.volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();

        if (GUILayout.Button(this.audioStream.isPlaying ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        if (this.audioStream.isPlaying)
        {
            if (GUILayout.Button(this.audioStream.isPaused ? "Resume" : "Pause", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        */
        ...
        GUILayout.Label(this.audioStreamMinimal.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);
        ...
        GUILayout.Label(Mathf.Round(this.audioStreamMinimal.volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();

        if (GUILayout.Button(this.audioStreamMinimal.isPlaying ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        if (this.audioStreamMinimal.isPlaying)
        {
            if (GUILayout.Button(this.audioStreamMinimal.isPaused ? "Resume" : "Pause", AudioStreamDemoSupport.guiStyleButtonNormal))
        ...
        */
        ...
        GUILayout.Label(_as.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);

        GUILayout.Label("Common Unity AudioClip", AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.Label("Clip: " + _as.clip.name, AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label(string.Format("State = {0} {1}"
        ...
        GUILayout.Label(string.Format("Input mix latency: {0} ms", this.audioSourceOutput.inputLatency), AudioStreamDemoSupport.guiStyleLabelNormal);
        GUILayout.Label(string.Format("Output device latency average: {0} ms{1}", this.audioSourceOutput.latencyAverage, underflow), AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        if (GUILayout.Button(_as.isPlaying ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
            if (_as.isPlaying)
            {
                _as.Stop();
