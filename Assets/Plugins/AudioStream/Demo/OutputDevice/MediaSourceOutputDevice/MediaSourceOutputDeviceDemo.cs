...
public class MediaSourceOutputDeviceDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        AudioStreamDemoSupport.GUIHeader(this.mediaSourceOutputDevice.fmodVersion);
        ...
        GUILayout.Label("This scene will play two MONO audio files opened from StreamingAssets on selected output device on selected channels of that output\r\n" +
            ...
            "(a MONO clip is used to more easily map channels in the audio files to output device channel/s)", AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.Label("Select output device and press Play (default output device is preselected)", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label(string.Format("-- user requested {0}, running on {1}", this.mediaSourceOutputDevice.outputDevice.name, this.mediaSourceOutputDevice.RuntimeOutputDriverID), AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        GUILayout.Label(this.mediaSourceOutputDevice.GetType() + "   ========================================", AudioStreamDemoSupport.guiStyleLabelSmall);
        GUILayout.Label(string.Format("State = {0}"
            , lastError + " " + lastErrorString
            )
            , AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.Label(string.Format("Output device latency average: {0} ms", this.mediaSourceOutputDevice.latencyAverage), AudioStreamDemoSupport.guiStyleLabelNormal);

        GUILayout.Space(10);

        GUILayout.Label("Select output channel of the selected output device to play the MONO clip on. You can select more than one channel (the same MONO clip will be played on all of them)\r\nYou can change output channels while playing.", AudioStreamDemoSupport.guiStyleLabelNormal);
            ...
            )
        {
            ...
            using (new GUILayout.HorizontalScope())
            {
                ...
                using (new GUILayout.VerticalScope())
                {
                    ...
                    GUILayout.Label("MONO AudioClip", AudioStreamDemoSupport.guiStyleLabelNormal);

                    GUILayout.Label("Clip: " + this.media1_StreamingAssetsFilename, AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    GUILayout.Label(Mathf.Round(this.channel1_volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    if (GUILayout.Button(this.mediaSourceOutputDevice.IsSoundPlaying(this.channel1) ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
                ...
                using (new GUILayout.VerticalScope())
                {
                    ...
                    GUILayout.Label("Clip: " + this.media2_StreamingAssetsFilename, AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    GUILayout.Label(Mathf.Round(this.channel2_volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    if (GUILayout.Button(this.mediaSourceOutputDevice.IsSoundPlaying(this.channel2) ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal))
            ...
            if (GUILayout.Button(anyPlaying ? "Stop both" : "Play both", AudioStreamDemoSupport.guiStyleButtonNormal))
                if (anyPlaying)
                {
                    this.mediaSourceOutputDevice.StopUserSound(this.channel1);
                    this.mediaSourceOutputDevice.StopUserSound(this.channel2);
