...
public class MediaSourcePlaybackDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("This scene will play testing 24 channel audio file on selected output\r\n" +
            ...
            "This component doesn't use Unity audio", AudioStreamDemoSupport.guiStyleLabelNormal);
        ...
        if (this.availableOutputs.Count > this.selectedOutput)
        {
            using (new GUILayout.HorizontalScope())
            {
                ...
                using (new GUILayout.VerticalScope())
                {
                    ...
                    GUILayout.Label("24 ch audio clip: " + this.media_StreamingAssetsFilename, AudioStreamDemoSupport.guiStyleLabelNormal);
                    GUILayout.Label("used with permission from Jon Olive of MagicBeans Physical Audio Ltd.", AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    GUILayout.Label(Mathf.Round(this.channel_volume * 100f) + " %", AudioStreamDemoSupport.guiStyleLabelNormal);
                    ...
                    if (GUILayout.Button(this.mediaSourceOutputDevice.IsSoundPlaying(this.channel) ? "Stop" : "Play", AudioStreamDemoSupport.guiStyleButtonNormal)
