...
namespace AudioStream
{
    public abstract class AudioStreamInputBase : MonoBehaviour
    {
        ...
        {
            // system updated in UpdateRecordBuffer
        }
        #endregion
        ...
        protected void UpdateRecordBuffer()
        {
            ...
            if (recordpos != lastrecordpos)
            {
                ...
                */
                result = sound.@lock((uint)(lastrecordpos * this.recChannels * this.channelSize), (uint)(this.blocklength * this.recChannels * this.channelSize), out ptr1, out ptr2, out len1, out len2);   /* if e.g. stereo 16bit, exinfo.numchannels * 2 = 1 sample = 4 bytes. */
